		...
		<tbody>
			<?php $__currentLoopData = $nonIntegratedShipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
                  ...
                  <th scope="row"><?php echo e($shipment->pedido_tiny); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\travelist-fluxo\resources\views/shipments.blade.php ENDPATH**/ ?>